...
import { D as t, E as n, F as r, I as i, P as a, f as o, h as s, k as c, l, t as u } from "./adapter-DdgmR4Id.js";
import { i as d } from "./Ticker-CsadseLF.js";
import { S as ee, a as f, c as te, o as p, t as ne, u as m, x as re } from "./Geometry-CASa6bwq.js";
import { n as ie, r as h } from "./Filter-DNPtpZTY.js";
import { Y as ae, Z as g, a as oe, i as se, t as ce } from "./RenderTargetSystem-D6chDflO.js";
import { F as _, M as le, c as ue, d as de, i as fe, o as pe, t as v, u as me } from "./GCManagedHash-EG4FSGJE.js";
import { a as y, c as he, f as ge, i as _e, n as ve, o as ye, s as be, t as xe, u as Se } from "./BufferResource-DHeIKYZu.js";
//#region node_modules/pixi.js/lib/utils/browser/isSafari.mjs
function Ce() {
	let { userAgent: e } = u.get().getNavigator();
...
var b = class {
	constructor() {
		...
		*/
		this._tempState = h.for2d(), this._didUploadHash = {};
	}
	init(e) {
...
var x = /* @__PURE__ */ ((e) => (e[e.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER", e[e.ARRAY_BUFFER = 34962] = "ARRAY_BUFFER", e[e.UNIFORM_BUFFER = 35345] = "UNIFORM_BUFFER", e))(x || {}), we = class {
	constructor(e, t) {
	...
	*/
	createGLBuffer(e) {
		let { _gl: t } = this, n = x.ARRAY_BUFFER;
		e.descriptor.usage & f.INDEX ? n = x.ELEMENT_ARRAY_BUFFER : e.descriptor.usage & f.UNIFORM && (n = x.UNIFORM_BUFFER);
		let r = new we(t.createBuffer(), n);
...
var C = class e {
	...
	*/
	...
	init(t) {
		...
		if (t.context && n && (l("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), n = !1), this.canvas = n ? u.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this._renderer.view.canvas, t.context) this.initFromContext(t.context);
		else {
	...
	ensureCanvasSize(e) {
		if (!this.multiView) {
			e !== this.canvas && l("multiView is disabled, but targetCanvas is not the main canvas");
			return;
		}
		let { canvas: t } = this;
	...
	*/
	initFromContext(e) {
		this.gl = e, this.webGLVersion = e instanceof u.get().getWebGLRenderingContext() ? 1 : 2, this.getExtensions(), this.validateContext(e), this._renderer.runners.contextChange.emit(e);
	...
	*/
	validateContext(e) {
		...
		t && !t.stencil && l("Provided WebGL context does not have a stencil buffer, masks may not render correctly");
		let n = this.supports, r = this.webGLVersion === 2, i = this.extensions;
		n.uint32Indices = r || !!i.uint32ElementIndex, n.uniformBufferObject = r, n.vertexArrayObject = r || !!i.vertexArrayObject, n.srgbTextures = r || !!i.srgb, n.nonPowOf2wrapping = r, n.nonPowOf2mipmaps = r, n.msaa = r, n.uint32Indices || l("Provided WebGL context does not support 32 index buffer, large scenes may not render correctly");
	}
};
...
var Te = C, w = /* @__PURE__ */ ((e) => (e[e.RGBA = 6408] = "RGBA", e[e.RGB = 6407] = "RGB", e[e.RG = 33319] = "RG", e[e.RED = 6403] = "RED", e[e.RGBA_INTEGER = 36249] = "RGBA_INTEGER", e[e.RGB_INTEGER = 36248] = "RGB_INTEGER", e[e.RG_INTEGER = 33320] = "RG_INTEGER", e[e.RED_INTEGER = 36244] = "RED_INTEGER", e[e.ALPHA = 6406] = "ALPHA", e[e.LUMINANCE = 6409] = "LUMINANCE", e[e.LUMINANCE_ALPHA = 6410] = "LUMINANCE_ALPHA", e[e.DEPTH_COMPONENT = 6402] = "DEPTH_COMPONENT", e[e.DEPTH_STENCIL = 34041] = "DEPTH_STENCIL", e))(w || {}), T = /* @__PURE__ */ ((e) => (e[e.TEXTURE_2D = 3553] = "TEXTURE_2D", e[e.TEXTURE_CUBE_MAP = 34067] = "TEXTURE_CUBE_MAP", e[e.TEXTURE_2D_ARRAY = 35866] = "TEXTURE_2D_ARRAY", e[e.TEXTURE_CUBE_MAP_POSITIVE_X = 34069] = "TEXTURE_CUBE_MAP_POSITIVE_X", e[e.TEXTURE_CUBE_MAP_NEGATIVE_X = 34070] = "TEXTURE_CUBE_MAP_NEGATIVE_X", e[e.TEXTURE_CUBE_MAP_POSITIVE_Y = 34071] = "TEXTURE_CUBE_MAP_POSITIVE_Y", e[e.TEXTURE_CUBE_MAP_NEGATIVE_Y = 34072] = "TEXTURE_CUBE_MAP_NEGATIVE_Y", e[e.TEXTURE_CUBE_MAP_POSITIVE_Z = 34073] = "TEXTURE_CUBE_MAP_POSITIVE_Z", e[e.TEXTURE_CUBE_MAP_NEGATIVE_Z = 34074] = "TEXTURE_CUBE_MAP_NEGATIVE_Z", e))(T || {}), Ee = /* @__PURE__ */ ((e) => (e[e.CLAMP = 33071] = "CLAMP", e[e.REPEAT = 10497] = "REPEAT", e[e.MIRRORED_REPEAT = 33648] = "MIRRORED_REPEAT", e))(Ee || {}), E = /* @__PURE__ */ ((e) => (e[e.UNSIGNED_BYTE = 5121] = "UNSIGNED_BYTE", e[e.UNSIGNED_SHORT = 5123] = "UNSIGNED_SHORT", e[e.UNSIGNED_SHORT_5_6_5 = 33635] = "UNSIGNED_SHORT_5_6_5", e[e.UNSIGNED_SHORT_4_4_4_4 = 32819] = "UNSIGNED_SHORT_4_4_4_4", e[e.UNSIGNED_SHORT_5_5_5_1 = 32820] = "UNSIGNED_SHORT_5_5_5_1", e[e.UNSIGNED_INT = 5125] = "UNSIGNED_INT", e[e.UNSIGNED_INT_10F_11F_11F_REV = 35899] = "UNSIGNED_INT_10F_11F_11F_REV", e[e.UNSIGNED_INT_2_10_10_10_REV = 33640] = "UNSIGNED_INT_2_10_10_10_REV", e[e.UNSIGNED_INT_24_8 = 34042] = "UNSIGNED_INT_24_8", e[e.UNSIGNED_INT_5_9_9_9_REV = 35902] = "UNSIGNED_INT_5_9_9_9_REV", e[e.BYTE = 5120] = "BYTE", e[e.SHORT = 5122] = "SHORT", e[e.INT = 5124] = "INT", e[e.FLOAT = 5126] = "FLOAT", e[e.FLOAT_32_UNSIGNED_INT_24_8_REV = 36269] = "FLOAT_32_UNSIGNED_INT_24_8_REV", e[e.HALF_FLOAT = 36193] = "HALF_FLOAT", e))(E || {}), D = {
	uint8x2: E.UNSIGNED_BYTE,
	uint8x4: E.UNSIGNED_BYTE,
	sint8x2: E.BYTE,
	sint8x4: E.BYTE,
	unorm8x2: E.UNSIGNED_BYTE,
	unorm8x4: E.UNSIGNED_BYTE,
	snorm8x2: E.BYTE,
	snorm8x4: E.BYTE,
	uint16x2: E.UNSIGNED_SHORT,
	uint16x4: E.UNSIGNED_SHORT,
	sint16x2: E.SHORT,
	sint16x4: E.SHORT,
	unorm16x2: E.UNSIGNED_SHORT,
	unorm16x4: E.UNSIGNED_SHORT,
	snorm16x2: E.SHORT,
	snorm16x4: E.SHORT,
	float16x2: E.HALF_FLOAT,
	float16x4: E.HALF_FLOAT,
	float32: E.FLOAT,
	float32x2: E.FLOAT,
	float32x3: E.FLOAT,
	float32x4: E.FLOAT,
	uint32: E.UNSIGNED_INT,
	uint32x2: E.UNSIGNED_INT,
	uint32x3: E.UNSIGNED_INT,
	uint32x4: E.UNSIGNED_INT,
	sint32: E.INT,
	sint32x2: E.INT,
	sint32x3: E.INT,
	sint32x4: E.INT
...
var Oe = {
	...
	*/
	initGeometryVao(e, t, n = !0) {
		...
		o || (o = new ke(), e._gpuData[this._renderer.uid] = o, this._managedGeometries.add(e));
		let s = o.vaoCache, c = s[a];
		if (c) return s[t._key] = c, c;
		he(e, t._attributeData);
		let l = e.buffers;
	...
	activateVao(e, t) {
		...
		for (let e in i) {
			...
			if (l) {
				...
				let t = re(o.format), i = De(o.format);
	...
	*/
	draw(e, t, n, r) {
		let { gl: i } = this._renderer, a = this._activeGeometry, o = Oe[e || a.topology];
...
var Ae = new ne({ attributes: { aPosition: [
	-1,
	-1,
	3,
	-1,
	...
	init(t = {}) {
		...
		this.useBackBuffer = n, this._antialias = r, this._renderer.context.supports.msaa || (l("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = h.for2d();
		let i = new ee({
	...
	*/
	...
	_getBackBufferTexture(e) {
		return this._backBufferTexture = this._backBufferTexture || new o({ source: new s({
			width: e.width,
			height: e.height,
...
var M = class {
	...
	contextChange() {
		...
		this.maxTextures = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS), this.maxBatchableTextures = le(this.maxTextures, e);
...
var Me = class {
	...
	setStencilMode(e, t) {
		let n = this._renderTargetStencilState[this._activeRenderTarget.uid], r = this._gl, i = be[e], a = this._stencilCache;
...
function F(e) {
	...
	for (let e = 0; e < t.length; e++) {
		let i = t[e];
		if (n = P[i.data.type], !n) throw Error(`Unknown type ${i.data.type}`);
...
function Ne(e, t) {
	let n = Math.max(P[e.data.type] / 16, 1), r = e.data.value.length / e.data.size, i = (4 - r % 4) % 4, a = e.data.type.indexOf("i32") >= 0 ? "dataInt32" : "data";
	return `
        v = uv.${e.data.name};
        offset += ${t};
...
var Fe = class {
	constructor() {
		...
		*/
		this._clearColorCache = [
			...
			0,
			0
		], this._viewPortCache = new t(), this._boundFramebuffer = void 0;
	}
	init(e, t) {
	...
	clear(e, t, n, r, i = 0, a = 0) {
		...
		if (typeof t == "boolean" && (t = t ? g.ALL : g.NONE), e.colorAttachments.length === 0 && (t &= ~g.COLOR, !t)) return;
		let s = this._renderer.gl, c = !!(t & g.DEPTH) && !this._renderer.state.depthMaskEnabled;
		if (t & g.COLOR) {
	...
	_initColor(e, t) {
		...
		if (t.resolveTargetFramebuffer = i, r.bindFramebuffer(r.FRAMEBUFFER, i), e.colorAttachments.forEach((e, i) => {
			let a = e.texture;
			a.antialias && (n.context.supports.msaa ? t.msaa = !0 : l("[RenderTexture] Antialiasing on textures is not supported in WebGL1")), n.texture.bindSource(a, 0);
	...
	_setDrawBuffers(e, t) {
		...
		if (this._renderer.context.webGLVersion === 1) {
			...
			e ? e.drawBuffersWEBGL(r) : l("[RenderTexture] This WebGL1 context does not support rendering to multiple targets");
	...
	*/
	resetState() {
		this._boundFramebuffer = void 0, this._viewPortCache = new t(), this._clearColorCache = [
			0,
			0,
			0,
			0
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureView.mjs
var Ie = class extends a {
	...
	*/
	constructor(e, t) {
		super(), this._resourceType = "textureView", this._resourceId = n("resource"), this._touched = 0, this.source = e, this.viewDescriptor = t, this._onChange = this._onChange.bind(this), this._onDestroy = this._onDestroy.bind(this), this.source.on("change", this._onChange), this.source.on("destroy", this._onDestroy);
	}
	_onChange() {
	...
	for (let c in e.groups) {
		...
		for (let u in l.resources) {
			...
			if (d instanceof m) {
                ...
                `);
			} else if (d instanceof s || d instanceof Ie) {
				let s = e._uniformBindMap[c][u], l = o.uniformData[s];
...
function Ge(e, t) {
	...
	for (let i = 0; i < r; i++) {
		let r = t.getActiveUniform(e, i), a = r.name.replace(/\[.*?\]$/, ""), o = !!r.name.match(/\[.*?\]$/), s = H(t, r.type);
		n[a] = {
			name: a,
			index: i,
			type: s,
...
function qe(e, t, n, r) {
	e.getProgramParameter(t, e.LINK_STATUS) || (e.getShaderParameter(n, e.COMPILE_STATUS) || Ke(e, n), e.getShaderParameter(r, e.COMPILE_STATUS) || Ke(e, r), console.error("PixiJS Error: Could not initialize shader."), e.getProgramInfoLog(t) !== "" && console.warn("PixiJS Warning: gl.getProgramInfoLog()", e.getProgramInfoLog(t)));
}
//#endregion
...
function Je(e, t) {
	...
	a && (typeof e.transformFeedbackVaryings == "function" ? e.transformFeedbackVaryings(i, a.names, a.bufferMode === "separate" ? e.SEPARATE_ATTRIBS : e.INTERLEAVED_ATTRIBS) : l("TransformFeedback is not supported but TransformFeedbackVaryings are given.")), e.linkProgram(i), e.getProgramParameter(i, e.LINK_STATUS) || qe(e, i, n, r), t._attributeData = Ue(i, e, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(t.vertex)), t._uniformData = Ge(i, e), t._uniformBlockData = We(i, e), e.deleteShader(n), e.deleteShader(r);
	let o = {};
...
var U = {
	...
	*/
	bind(e, t) {
		...
		U.textureCount = 0, U.blockIndex = 0;
		let n = this._shaderSyncFunctions[e.glProgram._key];
		n ||= this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this), this._renderer.buffer.nextBindBase(!!e.glProgram.transformFeedbackVaryings), n(this._renderer, e, U);
	}
	/**
	...
	*/
	updateUniformGroup(e) {
		this._renderer.uniformGroup.updateUniformGroup(e, this._activeProgram, U);
	}
	/**
	...
	*/
	...
	_createProgramData(e) {
		let t = e._key;
		return this._programDataHash[t] = Je(this._gl, e), this._programDataHash[t];
	}
	destroy() {
...
function Ze(e, t) {
	...
	for (let r in e.uniforms) {
		if (!t[r]) {
			e.uniforms[r] instanceof m ? e.uniforms[r].ubo ? n.push(`
                        renderer.shader.bindUniformBlock(uv.${r}, "${r}");
                    `) : n.push(`
                        renderer.shader.updateUniformGroup(uv.${r});
                    `) : e.uniforms[r] instanceof xe && n.push(`
		...
		for (let e = 0; e < y.length; e++) {
			...
			if (i.type === t.type && t.test(i)) {
				n.push(`name = "${r}";`, y[e].uniform), a = !0;
				break;
			}
		}
		if (!a) {
			let e = (i.size === 1 ? Ye : Xe)[i.type].replace("location", `ud["${r}"].location`);
			n.push(`
            cu = ud["${r}"];
            cv = cu.value;
            v = uv["${r}"];
...
function Qe(e) {
	...
	if (t.normal = [e.ONE, e.ONE_MINUS_SRC_ALPHA], t.add = [e.ONE, e.ONE], t.multiply = [
		...
		e.ONE,
		e.ONE_MINUS_SRC_ALPHA
	], t.erase = [e.ZERO, e.ONE_MINUS_SRC_ALPHA], !(e instanceof u.get().getWebGLRenderingContext())) t.min = [
		e.ONE,
		e.ONE,
		e.ONE,
		e.ONE,
...
var ot = at, st = class {
	constructor(e) {
		this.target = T.TEXTURE_2D, this._layerInitMask = 0, this.texture = e, this.width = -1, this.height = -1, this.type = E.UNSIGNED_BYTE, this.internalFormat = w.RGBA, this.format = w.RGBA, this.samplerType = 0;
	}
	destroy() {}
}, ct = {
	id: "buffer",
	...
	upload(e, t, n, r, i, a) {
		...
		let s = e.pixelWidth, c = e.pixelHeight, l = !!lt[e.format];
	...
	return {
		...
		upload(t, n, r, i) {
			...
			for (let t = 0; t < dt.length; t++) {
				let o = a[dt[t]];
				o.resource && ((e[o.uploadMethodId] || e.image).upload(o, n, r, i, T.TEXTURE_CUBE_MAP_POSITIVE_X + t, !(n._layerInitMask & 1 << t)), n._layerInitMask |= 1 << t);
			}
...
var K = {
	id: "image",
	upload(e, t, n, r, i, a = !1) {
		let o = i || t.target, s = e.pixelWidth, c = e.pixelHeight, l = e.resourceWidth, u = e.resourceHeight, d = r === 2, ee = a || t.width !== s || t.height !== c, f = l >= s && u >= c, te = e.resource;
		(d ? pt : mt)(n, o, t, s, c, l, u, te, ee, f), t.width = s, t.height = c;
	}
};
...
function Y(e, t, n, r, i, a, o, s) {
	...
	if (!s || e.addressModeU !== "repeat" || e.addressModeV !== "repeat" || e.addressModeW !== "repeat") {
		let n = J[o ? "clamp-to-edge" : e.addressModeU], r = J[o ? "clamp-to-edge" : e.addressModeV], a = J[o ? "clamp-to-edge" : e.addressModeW];
		t[i](c, t.TEXTURE_WRAP_S, n), t[i](c, t.TEXTURE_WRAP_T, r), t.TEXTURE_WRAP_R && t[i](c, t.TEXTURE_WRAP_R, a);
	}
	if ((!s || e.magFilter !== "linear") && t[i](c, t.TEXTURE_MAG_FILTER, q[e.magFilter]), n) {
		if (!s || e.mipmapFilter !== "linear") {
			let n = _t[e.minFilter][e.mipmapFilter];
			t[i](c, t.TEXTURE_MIN_FILTER, n);
		}
	} else t[i](c, t.TEXTURE_MIN_FILTER, q[e.minFilter]);
	...
	e.compare ? (t[i](c, t.TEXTURE_COMPARE_FUNC, vt[e.compare]), t[i](c, t.TEXTURE_COMPARE_MODE, t.COMPARE_REF_TO_TEXTURE)) : s || t[i](c, t.TEXTURE_COMPARE_MODE, t.NONE);
}
//#endregion
...
function bt(e, t) {
	let n = {}, r = e.RGBA;
	return e instanceof u.get().getWebGLRenderingContext() ? t.srgb && (n = {
...
var Ct = 4, X = class e {
	...
	*/
	...
	contextChange(e) {
		this._gl = e, this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = bt(e, this._renderer.context.extensions), this._mapFormatToType = xt(e), this._mapFormatToFormat = yt(e), this._mapViewDimensionToGlTarget = St(e)), this._managedTextures.removeAll(!0), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundSamplers = /* @__PURE__ */ Object.create(null), this._premultiplyAlpha = !1;
	...
	*/
	...
	_initSource(e) {
		let t = this._gl, n = new st(t.createTexture());
	...
	updateStyle(e, t) {
		...
		n.bindTexture(r.target, r.texture), this._boundTextures[this._activeTextureLocation] = e, Y(e.style, n, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", r.target, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, t);
	}
	...
	*/
	...
	_initSampler(e) {
		...
		return this._glSamplers[e._resourceId] = n, Y(e, t, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", n, !1, !0), this._glSamplers[e._resourceId];
	}
	_getGlSampler(e) {
	...
	generateCanvas(e) {
		let { pixels: t, width: n, height: r } = this.getPixels(e), i = u.get().createCanvas();
	...
	getPixels(e) {
		let t = e.source.resolution, n = e.frame, r = Math.max(Math.round(n.width * t), 1), i = Math.max(Math.round(n.height * t), 1), a = new Uint8Array(Ct * r * i), o = this._renderer, s = o.renderTarget.getRenderTarget(e), c = o.renderTarget.getGpuRenderTarget(s), l = o.gl;
...
X.extension = {
	type: [r.WebGLSystem],
	name: "texture"
}, X.uploadExtensions = /* @__PURE__ */ Object.create(null);
var Z = X;
i.handleByMap(r.TextureUploaderWebGL, Z.uploadExtensions);
//#endregion
...
var Q = class {
	contextChange(e) {
		...
		}), n = e.limits.maxBatchableTextures, r = de({
			name: "graphics",
			bits: [
				me,
				ue(n),
...
var $ = class {
	...
	execute(e, t) {
		...
		if (!r) {
			...
			l("Mesh shader has no glProgram", t.shader);
			return;
		}
...
var wt = /* @__PURE__ */ e({ WebGLRenderer: () => jt }), Tt = [
	...oe,
	I,
	je,
	Te,
...
i.handleByNamedList(r.WebGLSystem, Ot), i.handleByNamedList(r.WebGLPipes, kt), i.handleByNamedList(r.WebGLPipesAdaptor, At), i.add(...Tt, ...Et, ...Dt);
var jt = class extends ae {
	constructor() {
		let e = {
			...
			systems: Ot,
			renderPipes: kt,
			renderPipeAdaptors: At
		};
		super(e);
	}
};
//#endregion
export { je as $, Ge as A, Ie as B, G as C, W as D, Ye as E, B as F, Ne as G, Fe as H, R as I, N as J, P as K, ze as L, Ue as M, He as N, Je as O, H as P, A as Q, Re as R, Qe as S, Xe as T, I as U, L as V, Pe as W, M as X, Me as Y, j as Z, ft as _, Z as a, E as at, st as b, bt as c, S as ct, vt as d, b as dt, ke as et, _t as f, Ce as ft, K as g, gt as h, Q as i, T as it, We as j, qe as k, yt as l, we as lt, J as m, wt as n, De as nt, St as o, Ee as ot, q as p, F as q, $ as r, w as rt, xt as s, Te as st, jt as t, O as tt, Y as u, x as ut, ut as v, Ze as w, ot as x, ct as y, Le as z };
