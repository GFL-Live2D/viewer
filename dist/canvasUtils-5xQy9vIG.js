import { F as e, O as t, h as n, t as r, u as i } from "./adapter-DdgmR4Id.js";
...
var l = {
	...
	getCanvasSource: (e) => {
		...
		if (n instanceof Uint8Array || n instanceof Uint8ClampedArray || n instanceof Int8Array || n instanceof Uint16Array || n instanceof Int16Array || n instanceof Uint32Array || n instanceof Int32Array || n instanceof Float32Array || n instanceof ArrayBuffer) {
			...
			if (e?.resourceId === t._resourceId) return e.canvas;
			let i = r.get().createCanvas(t.pixelWidth, t.pixelHeight), a = i.getContext("2d"), o = a.createImageData(t.pixelWidth, t.pixelHeight), s = o.data, c = n instanceof ArrayBuffer ? new Uint8Array(n) : new Uint8Array(n.buffer, n.byteOffset, n.byteLength);
		...
		if (i) {
			let e = r.get().createCanvas(t.pixelWidth, t.pixelHeight), i = e.getContext("2d", { willReadFrequently: !0 });
			e.width = t.pixelWidth, e.height = t.pixelHeight, i.drawImage(n, 0, 0);
		...
		if (s) {
			let e = l._canvasSourceCache.get(t);
			if (e?.resourceId === t._resourceId) return e.canvas;
			let i = r.get().createCanvas(t.pixelWidth, t.pixelHeight), a = i.getContext("2d");
			return i.width = t.pixelWidth, i.height = t.pixelHeight, a.drawImage(n, 0, 0), l._canvasSourceCache.set(t, {
				canvas: i,
				resourceId: t._resourceId
			}), i;
		}
	...
	getTintedCanvas: (e, t) => {
		let n = e.texture, a = i.shared.setValue(t).toHex(), o = n.tintCache ||= {}, s = o[a], c = n.source._resourceId;
		if (s?.tintId === c) return s;
		let u = s && "getContext" in s ? s : r.get().createCanvas();
		if (l.tintMethod(n, t, u), u.tintId = c, l.convertTintToImage && u.toDataURL !== void 0) {
			let e = r.get().createImage();
			e.src = u.toDataURL(), e.tintId = c, o[a] = e;
		} else o[a] = u;
		return o[a];
	},
	getTintedPattern: (e, t) => {
		let n = i.shared.setValue(t).toHex(), a = e.patternCache ||= {}, o = e.source._resourceId, s = a[n];
		return s?.tintId === o ? s : (l.canvas ||= r.get().createCanvas(), l.tintMethod(e, t, l.canvas), s = l.canvas.getContext("2d").createPattern(l.canvas, "repeat"), s.tintId = o, a[n] = s, s);
	},
	/**
	...
	*/
	...
	tintWithMultiply: (e, n, r) => {
		let a = r.getContext("2d"), o = e.frame.clone(), s = e.source._resolution ?? e.source.resolution ?? 1, c = e.rotate;
		o.x *= s, o.y *= s, o.width *= s, o.height *= s;
		let u = t.isVertical(c), d = u ? o.height : o.width, f = u ? o.width : o.height;
		r.width = Math.ceil(d), r.height = Math.ceil(f), a.save(), a.fillStyle = i.shared.setValue(n).toHex(), a.fillRect(0, 0, d, f), a.globalCompositeOperation = "multiply";
	...
	tintWithOverlay: (e, n, r) => {
		let a = r.getContext("2d"), o = e.frame.clone(), s = e.source._resolution ?? e.source.resolution ?? 1, c = e.rotate;
		o.x *= s, o.y *= s, o.width *= s, o.height *= s;
		let u = t.isVertical(c), d = u ? o.height : o.width, f = u ? o.width : o.height;
		r.width = Math.ceil(d), r.height = Math.ceil(f), a.save(), a.globalCompositeOperation = "copy", a.fillStyle = i.shared.setValue(n).toHex(), a.fillRect(0, 0, d, f), a.globalCompositeOperation = "destination-atop";
		let p = l.getCanvasSource(e);
		if (!p) {
			a.restore();
			return;
