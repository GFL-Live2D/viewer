import { E as e, P as t, l as n } from "./adapter-DdgmR4Id.js";
import { a as r, i, x as a } from "./Geometry-CASa6bwq.js";
import { Q as o } from "./RenderTargetSystem-D6chDflO.js";
import { F as s } from "./GCManagedHash-EG4FSGJE.js";
...
function p(e, t) {
	for (let r in e.attributes) {
		let i = e.attributes[r], a = t[r];
		a ? (i.format ??= a.format, i.offset ??= a.offset, i.instance ??= a.instance) : n(`Attribute ${r} is not present in the shader, but is present in the geometry. Unable to infer attribute details.`);
	}
	m(e);
}
function m(e) {
	...
	for (let e in n) {
		let t = n[e];
		r[t.buffer.uid] += a(t.format).stride;
	}
	for (let e in n) {
		let t = n[e];
		t.stride ??= r[t.buffer.uid], t.start ??= i[t.buffer.uid], i[t.buffer.uid] += a(t.format).stride;
	}
}
//#endregion
