...
//#region node_modules/interactjs/dist/interact.min.js
	...
	(function(n, r) {
		...
		var C = {
			...
			install: function(e) {
				...
				n.prototype.draggable = C.draggable, t.map.drag = C, t.methodDict.drag = "draggable", r.actions.drag = C.defaults;
			},
			listeners: {
				"interactions:before-action-move": ee,
				"interactions:action-resume": ee,
			...
			init: function(e) {
				var t = e;
				w.document = t.document, w.DocumentFragment = t.DocumentFragment || T, w.SVGElement = t.SVGElement || T, w.SVGSVGElement = t.SVGSVGElement || T, w.SVGElementInstance = t.SVGElementInstance || T, w.Element = t.Element || T, w.HTMLElement = t.HTMLElement || w.Element, w.Event = t.Event, w.Touch = t.Touch || T, w.PointerEvent = t.PointerEvent || t.MSPointerEvent;
			},
			document: null,
		...
		var E = w, D = {
			init: function(e) {
				var t = E.Element, n = e.navigator || {};
				D.supportsTouch = "ontouchstart" in e || S.func(e.DocumentTouch) && E.document instanceof e.DocumentTouch, D.supportsPointerEvent = !1 !== n.pointerEnabled && !!E.PointerEvent, D.isIOS = /iP(hone|od|ad)/.test(n.platform), D.isIOS7 = /iP(hone|od|ad)/.test(n.platform) && /OS 7[^\d]/.test(n.appVersion), D.isIe9 = /MSIE 9/.test(n.userAgent), D.isOperaMobile = n.appName === "Opera" && D.supportsTouch && /Presto/.test(n.userAgent), D.prefixedMatchesSelector = "matches" in t.prototype ? "matches" : "webkitMatchesSelector" in t.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in t.prototype ? "mozMatchesSelector" : "oMatchesSelector" in t.prototype ? "oMatchesSelector" : "msMatchesSelector", D.pEventTypes = D.supportsPointerEvent ? E.PointerEvent === e.MSPointerEvent ? {
					up: "MSPointerUp",
					down: "MSPointerDown",
					over: "mouseover",
					out: "mouseout",
				...
				} : null, D.wheelEvent = E.document && "onmousewheel" in E.document ? "mousewheel" : "wheel";
			},
			supportsTouch: null,
		...
		function j(e, t) {
			return _ !== g && (t = t.replace(/\/deep\//g, " ")), e[O.prefixedMatchesSelector](t);
		}
		var ie = function(e) {
			return e.parentNode || e.host;
		};
		function ae(e, t) {
			for (var n, r = [], i = e; (n = ie(i)) && i !== t && n !== i.ownerDocument;) r.unshift(i), i = n;
			return r;
		}
		function oe(e, t, n) {
			for (; S.element(e);) {
				if (j(e, t)) return !0;
				if ((e = A(e)) === n) return j(e, t);
			}
			return !1;
		}
		function se(e) {
		...
		function ce(e) {
			var t = e instanceof E.SVGElement ? e.getBoundingClientRect() : e.getClientRects()[0];
			return t && {
				left: t.left,
				right: t.right,
				top: t.top,
		...
		function ue(e) {
			for (var t = []; e;) t.push(e), e = A(e);
			return t;
		}
		function de(e) {
			return !!S.string(e) && (E.document.querySelector(e), !0);
		}
		function M(e, t) {
		...
		function fe(e, t, n) {
			return e === "parent" ? A(n) : e === "self" ? t.getRect(n) : re(n, e);
		}
		function N(e, t, n, r) {
			var i = e;
			return S.string(i) ? i = fe(i, t, n) : S.func(i) && (i = i.apply(void 0, r)), S.element(i) && (i = le(i)), i;
		}
		function pe(e) {
			return e && {
				x: "x" in e ? e.x : e.left,
		...
		function me(e) {
			return !e || "x" in e && "y" in e || ((e = M({}, e)).x = e.left || 0, e.y = e.top || 0, e.width = e.width || (e.right || 0) - e.x, e.height = e.height || (e.bottom || 0) - e.y), e;
		}
		function he(e, t, n) {
		...
		function P(e, t, n) {
			var r = n && e.options[n];
			return pe(N(r && r.origin || e.options.origin, e, t, [e && t])) || {
				x: 0,
				y: 0
			};
		}
		function F(e, t) {
			...
			if (r ||= {}, S.string(e) && e.search(" ") !== -1 && (e = ge(e)), S.array(e)) return e.forEach((function(e) {
				return F(e, t, n, r);
			})), r;
			...
			else if (S.object(t)) for (var s in t) F(ge(s).map((function(t) {
				return `${e}${t}`;
			})), t[s], n, r);
			return r;
		}
		...
		function xe(e) {
			return e instanceof E.Event || e instanceof E.Touch;
		}
		function Se(e, t, n) {
		...
		function Ce(e, t) {
			return t ||= {
				x: 0,
				y: 0
			}, O.isOperaMobile && xe(e) ? (Se("screen", e, t), t.x += window.scrollX, t.y += window.scrollY) : Se("page", e, t), t;
		}
		function L(e) {
		...
		function we(e, t, n) {
			...
			Ce(r, e.page), function(e, t) {
				t ||= {}, O.isOperaMobile && xe(e) ? Se("screen", e, t) : Se("client", e, t);
		...
		function Oe(e, t) {
			...
			return I(i[0][n] - i[1][n], i[0][r] - i[1][r]);
		}
		function ke(e, t) {
		...
		function Ae(e) {
			return S.string(e.pointerType) ? e.pointerType : S.number(e.pointerType) ? [
				...
				"pen",
				"mouse"
			][e.pointerType] : /touch/.test(e.type || "") || e instanceof E.Touch ? "touch" : "mouse";
		}
		function je(e) {
			var t = S.func(e.composedPath) ? e.composedPath() : e.path;
			return [se(t ? t[0] : e.target), se(e.currentTarget)];
		}
		var Me = function() {
			function e(t) {
			...
			return o(n, [
				{
					...
					value: function() {
						...
						if (this.type === "dropactivate" || this.dropzone && t.cur.dropzone === this.dropzone && t.cur.element === this.target) {
							if (t.prev.dropzone = this.dropzone, t.prev.element = this.target, t.rejected = !0, t.events.enter = null, this.stopImmediatePropagation(), this.type === "dropactivate") {
								var r = t.activeDrops, i = R(r, (function(t) {
			...
			for (var n = function(e, t) {
				for (var n = [], r = 0, i = e.interactables.list; r < i.length; r++) {
					...
					if (a.options.drop.enabled) {
						...
						if (!(S.element(o) && o !== t || S.string(o) && !j(t, o) || S.func(o) && !o({
							dropzone: a,
							draggableElement: t
			...
			var m = function(e) {
				for (var t, n, r, i = [], a = 0; a < e.length; a++) {
					...
					if (o && a !== t) {
						if (s) {
							var c = ie(o), l = ie(s);
							if (c !== o.ownerDocument) {
								if (l !== o.ownerDocument) {
									if (c !== l) {
										i = i.length ? i : ae(s);
										var u = void 0;
										if (s instanceof E.HTMLElement && o instanceof E.SVGElement && !(o instanceof E.SVGSVGElement)) {
											if (o === l) continue;
											u = o.ownerSVGElement;
										} else u = o;
										for (var d = ae(u, s.ownerDocument), f = 0; d[f] && d[f] === i[f];) f++;
										var p = [
											d[f - 1],
											d[f],
											i[f]
		...
		function Re(e, t, n) {
			...
			return n.type === "dragstart" && (i.activate = new B(r, n, "dropactivate"), i.activate.target = null, i.activate.dropzone = null), n.type === "dragend" && (i.deactivate = new B(r, n, "dropdeactivate"), i.deactivate.target = null, i.deactivate.dropzone = null), r.rejected || (r.cur.element !== r.prev.element && (r.prev.dropzone && (i.leave = new B(r, n, "dragleave"), n.dragLeave = i.leave.target = r.prev.element, n.prevDropzone = i.leave.dropzone = r.prev.dropzone), r.cur.dropzone && (i.enter = new B(r, n, "dragenter"), n.dragEnter = r.cur.element, n.dropzone = r.cur.dropzone)), n.type === "dragend" && r.cur.dropzone && (i.drop = new B(r, n, "drop"), n.dropzone = r.cur.dropzone, n.relatedTarget = r.cur.element), n.type === "dragmove" && r.cur.dropzone && (i.move = new B(r, n, "dropmove"), n.dropzone = r.cur.dropzone)), i;
		}
		function ze(e, t) {
			var n = e.dropState, r = n.activeDrops, i = n.cur, a = n.prev;
			t.leave && a.dropzone.fire(t.leave), t.enter && i.dropzone.fire(t.enter), t.move && i.dropzone.fire(t.move), t.drop && i.dropzone.fire(t.drop), t.deactivate && Fe(r, t.deactivate), n.prev.dropzone = i.dropzone, n.prev.element = i.element;
		}
		function Be(e, t) {
			var n = e.interaction, r = e.iEvent, i = e.event;
			if (r.type === "dragmove" || r.type === "dragend") {
				var a = n.dropState;
				t.dynamicDrop && (a.activeDrops = Ie(t, n.element));
				var o = r, s = Le(n, o, i);
				a.rejected = a.rejected && !!s && s.dropzone === a.cur.dropzone && s.element === a.cur.element, a.cur.dropzone = s && s.dropzone, a.cur.element = s && s.element, a.events = Re(n, 0, o);
			}
		}
		var Ve = {
			id: "actions/drop",
			install: function(e) {
				...
				e.usePlugin(ne), r.prototype.dropzone = function(e) {
					return function(e, t) {
						if (S.object(t)) {
							if (e.options.drop.enabled = !1 !== t.enabled, t.listeners) {
								var n = F(t.listeners), r = Object.keys(n).reduce((function(e, t) {
					...
					dropmove: !0,
					drop: !0
				}), t.methodDict.drop = "dropzone", e.dynamicDrop = !1, i.actions.drop = Ve.defaults;
			},
			listeners: {
				...
				"interactions:after-action-start": function(e, t) {
					...
					if (n.prepared.name === "drag") {
						var i = n.dropState;
						i.activeDrops = [], i.events = {}, i.activeDrops = Ie(t, n.element), i.events = Re(n, 0, r), i.events.activate && (Fe(i.activeDrops, i.events.activate), t.fire("actions/drop:start", {
							interaction: n,
							dragEvent: r
						}));
					}
				...
				"interactions:after-action-move": function(e, t) {
					...
					if (n.prepared.name === "drag") {
						var i = n.dropState;
						ze(n, i.events), t.fire("actions/drop:move", {
							interaction: n,
							dragEvent: r
						}), i.events = {};
					}
				...
				"interactions:action-end": function(e, t) {
					if (e.interaction.prepared.name === "drag") {
						var n = e.interaction, r = e.iEvent;
						Be(e, t), ze(n, n.dropState.events), t.fire("actions/drop:end", {
							interaction: n,
							dragEvent: r
						});
					}
		...
		function Ue(e) {
			...
			if (t.prepared.name === "gesture") {
				...
				t.gesture.distance = n.distance, t.gesture.angle = n.angle, S.number(n.scale) && n.scale !== 1 / 0 && !isNaN(n.scale) && (t.gesture.scale = n.scale);
			}
		}
		var We = {
			id: "actions/gesture",
			...
			install: function(e) {
				...
				}, t.map.gesture = We, t.methodDict.gesture = "gesturable", r.actions.gesture = We.defaults;
			},
			listeners: {
				"interactions:action-start": Ue,
				"interactions:action-move": Ue,
				"interactions:action-end": Ue,
		...
		function Ke(e, t, n, r, i, a, o) {
			...
			return !!S.element(r) && (S.element(t) ? t === r : oe(r, t, i));
		}
		function qe(e) {
			var t = e.iEvent, n = e.interaction;
		...
		var V, H, U = {
			...
			install: function(e) {
				...
				}(n), U.defaultMargin = n.supportsTouch || n.supportsPointerEvent ? 20 : 10, r.prototype.resizable = function(t) {
				...
				}, t.map.resize = U, t.methodDict.resize = "resizable", i.actions.resize = U.defaults;
			},
			listeners: {
				"interactions:new": function(e) {
				...
				"auto-start:check": function(e) {
					...
					if (i) {
						var o = M({}, t.coords.cur.page), s = n.options.resize;
						if (s && s.enabled && (!t.pointerIsDown || !/mouse|pointer/.test(t.pointerType) || (a & s.mouseButtons) != 0)) {
							if (S.object(s.edges)) {
								...
								for (var l in c) c[l] = Ke(l, s.edges[l], o, t._latestPointer.eventTarget, r, i, s.margin || U.defaultMargin);
								c.left = c.left && !c.right, c.top = c.top && !c.bottom, (c.left || c.right || c.top || c.bottom) && (e.action = {
									name: "resize",
									edges: c
								});
							} else {
								var u = s.axis !== "y" && o.x > i.right - U.defaultMargin, d = s.axis !== "x" && o.y > i.bottom - U.defaultMargin;
								(u || d) && (e.action = {
									name: "resize",
									axes: (u ? "x" : "") + (d ? "y" : "")
								});
			...
			getCursor: function(e) {
				var t = e.edges, n = e.axis, r = e.name, i = U.cursors, a = null;
				if (n) a = i[r + n];
				else if (t) {
					for (var o = "", s = 0, c = [
						"top",
			...
			id: "actions",
			install: function(e) {
				e.usePlugin(Ge), e.usePlugin(Je), e.usePlugin(ne), e.usePlugin(He);
			}
		}, Xe = 0, W = {
			request: function(e) {
				return V(e);
			...
			init: function(e) {
				if (V = e.requestAnimationFrame, H = e.cancelAnimationFrame, !V) for (var t = [
					"ms",
					"moz",
					"webkit",
					"o"
					...
					var r = t[n];
					V = e[`${r}RequestAnimationFrame`], H = e[`${r}CancelAnimationFrame`] || e[`${r}CancelRequestAnimationFrame`];
				}
				V &&= V.bind(e), H &&= H.bind(e), V || (V = function(t) {
					var n = Date.now(), r = Math.max(0, 16 - (n - Xe)), i = e.setTimeout((function() {
						t(n + r);
					}), r);
					return Xe = n + r, i;
				}, H = function(e) {
			...
			speed: 0,
			start: function(e) {
				G.isScrolling = !0, W.cancel(G.i), e.autoScroll = G, G.interaction = e, G.prevTime = G.now(), G.i = W.request(G.scroll);
			},
			stop: function() {
				G.isScrolling = !1, G.interaction && (G.interaction.autoScroll = null), W.cancel(G.i);
			},
			scroll: function() {
				var e = G.interaction, t = e.interactable, n = e.element, r = e.prepared.name, i = t.options[r].autoScroll, a = Ze(i.container, t, n), o = G.now(), s = (o - G.prevTime) / 1e3, c = i.speed * s;
				if (c >= 1) {
					var l = {
						x: G.x * c,
						y: G.y * c
				...
				G.isScrolling && (W.cancel(G.i), G.i = W.request(G.scroll));
			},
			check: function(e, t) {
			...
			onInteractionMove: function(e) {
				...
				if (t.interacting() && G.check(t.interactable, t.prepared.name)) {
					if (t.simulation) G.x = G.y = 0;
					else {
						var r, i, a, o, s = t.interactable, c = t.element, l = t.prepared.name, u = s.options[l].autoScroll, d = Ze(u.container, s, c);
						if (S.window(d)) o = n.clientX < G.margin, r = n.clientY < G.margin, i = n.clientX > d.innerWidth - G.margin, a = n.clientY > d.innerHeight - G.margin;
						else {
							var f = ce(d);
							o = n.clientX < f.left + G.margin, r = n.clientY < f.top + G.margin, i = n.clientX > f.right - G.margin, a = n.clientY > f.bottom - G.margin;
						}
						G.x = i ? 1 : o ? -1 : 0, G.y = a ? 1 : r ? -1 : 0, G.isScrolling || (G.margin = u.margin, G.speed = u.speed, G.start(t));
					}
				}
			}
		};
		function Ze(e, t, n) {
			return (S.string(e) ? fe(e, t, n) : e) || y(n);
		}
		function Qe(e) {
		...
		var $e = {
			...
			install: function(e) {
				...
				e.autoScroll = G, G.now = function() {
					return e.now();
				}, n.phaselessTypes.autoscroll = !0, t.perAction.autoScroll = G.defaults;
			},
			listeners: {
				"interactions:new": function(e) {
				...
				"interactions:destroy": function(e) {
					e.interaction.autoScroll = null, G.stop(), G.interaction &&= null;
				},
				"interactions:stop": G.stop,
				"interactions:action-move": function(e) {
					return G.onInteractionMove(e);
				}
			}
		};
		function K(e, t) {
		...
		var rt = {
			...
			install: function(e) {
				...
				}, t.prototype.ignoreFrom = K((function(e) {
					return this._backCompatOption("ignoreFrom", e);
				}), "Interactable.ignoreFrom() has been deprecated. Use Interactble.draggable({ignoreFrom: newValue})."), t.prototype.allowFrom = K((function(e) {
					return this._backCompatOption("allowFrom", e);
				}), "Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue})."), t.prototype.actionChecker = nt, t.prototype.styleCursor = tt;
			}
		};
		function it(e, t, n, r, i) {
			return t.testIgnoreAllow(t.options[e.name], n, r) && t.options[e.name].enabled && ct(t, n, e, i) ? e : null;
		}
		...
		function st(e, t, n) {
			...
			r ||= { name: null }, e.interactable = i, e.element = a, et(e.prepared, r), e.rect = i && r.name ? i.getRect(a) : null, dt(e, n), n.fire("autoStart:prepared", { interaction: e });
		}
		function ct(e, t, n, r) {
		...
		function dt(e, t) {
			...
			if (e.pointerType === "mouse" && n && n.options.styleCursor) {
				...
				ut(e.element, a || "", t);
			} else t.autoStart.cursorElement && ut(t.autoStart.cursorElement, "", t);
		}
		var ft = {
			id: "auto-start/base",
			before: ["actions"],
			install: function(e) {
				...
				e.usePlugin(rt), n.base.actionChecker = null, n.base.styleCursor = !0, M(n.perAction, {
					manualStart: !1,
					max: 1 / 0,
					maxPerElement: 1,
					allowFrom: null,
			...
			listeners: {
				"interactions:down": function(e, t) {
					...
					n.interacting() || st(n, ot(n, r, i, a, t), t);
				},
				"interactions:move": function(e, t) {
					(function(e, t) {
						var n = e.interaction, r = e.pointer, i = e.event, a = e.eventTarget;
						n.pointerType !== "mouse" || n.pointerIsDown || n.interacting() || st(n, ot(n, r, i, a, t), t);
					})(e, t), function(e, t) {
						var n = e.interaction;
						if (n.pointerIsDown && !n.interacting() && n.pointerWasMoved && n.prepared.name) {
							t.fire("autoStart:before-start", e);
							var r = n.interactable, i = n.prepared.name;
							i && r && (r.options[i].manualStart || !ct(r, n.element, n.prepared, t) ? n.stop() : (n.start(n.prepared, r, n.element), dt(n, t)));
						}
					}(e, t);
				},
				"interactions:stop": function(e, t) {
					var n = e.interaction, r = n.interactable;
					r && r.options.styleCursor && ut(n.element, "", t);
				}
			},
			maxInteractions: lt,
			withinInteractionLimit: ct,
						...
						for (var d = r, f = function(e) {
							if (e !== n.interactable) {
								...
								if (!i.manualStart && e.testIgnoreAllow(i, d, r)) {
									...
									}(u, e) && ft.validateAction(a, e, d, r, t)) return e;
								}
							}
						}; S.element(d);) {
		...
		var ht = {
			...
			install: function(e) {
				var t = e.defaults;
				e.usePlugin(ft), t.perAction.hold = 0, t.perAction.delay = 0;
			},
			listeners: {
				"interactions:new": function(e) {
			...
			id: "auto-start",
			install: function(e) {
				e.usePlugin(ft), e.usePlugin(ht), e.usePlugin(pt);
			}
		}, _t = function(e) {
		...
		var yt = {
			...
			install: function(e) {
				var t = e.Interactable;
				t.prototype.preventDefault = _t, t.prototype.checkAndPreventDefault = function(t) {
					return function(e, t, n) {
						...
						if (r !== "never") {
							if (r !== "always") {
								...
								/^(mouse|pointer|touch)*(down|start)/i.test(n.type) || S.element(n.target) && j(n.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *") || n.preventDefault();
					...
					listener: function(t) {
						for (var n = 0, r = e.interactions.list; n < r.length; n++) {
							var i = r[n];
							if (i.element && (i.element === t.target || k(i.element, t.target))) return void i.interactable.checkAndPreventDefault(t);
						}
					}
				});
			},
		...
		function q(e) {
			...
			for (var n in e) {
				var r = e[n];
				t[n] = S.plainObject(r) ? q(r) : S.array(r) ? Pe(r) : r;
			}
			return t;
		}
		var xt = function() {
			...
			return o(e, [
				{
					...
					value: function(e, t) {
						...
						this.prepareStates(o), this.startEdges = M({}, a.edges), this.edges = M({}, this.startEdges), this.startOffset = (n = a.rect, r = t, n ? {
							left: r.x - n.left,
							top: r.y - n.top,
							right: n.right - r.x,
							bottom: n.bottom - r.y
				...
				},
				{
					...
					value: function(e) {
						...
						e.coords = M({}, e.pageCoords), e.rect = M({}, i), e.edges = M({}, a);
						for (var o = r ? this.states.slice(r) : this.states, s = St(e.coords, e.rect), c = 0; c < o.length; c++) {
							var l, u = o[c], d = u.options, f = M({}, e.coords), p = null;
							(l = u.methods) != null && l.set && this.shouldDo(d, n, t) && (e.state = u, p = u.methods.set(e), he(e.edges, e.rect, {
								x: e.coords.x - f.x,
								y: e.coords.y - f.y
							})), s.eventProps.push(p);
						}
						M(this.edges, e.edges), s.delta.x = e.coords.x - e.pageCoords.x, s.delta.y = e.coords.y - e.pageCoords.y, s.rectDelta.left = e.rect.left - i.left, s.rectDelta.right = e.rect.right - i.right, s.rectDelta.top = e.rect.top - i.top, s.rectDelta.bottom = e.rect.bottom - i.bottom;
				...
				},
				{
					...
					value: function(e) {
						...
						n === "start" && M(this.startDelta, a.delta);
				...
				},
				{
					...
					value: function(e) {
						this.startOffset = e.startOffset, this.startDelta = e.startDelta, this.startEdges = e.startEdges, this.edges = e.edges, this.states = e.states.map((function(e) {
							return q(e);
						})), this.result = St(M({}, e.result.coords), M({}, e.result.rect));
					}
				},
				{
					key: "destroy",
		...
		var Ct = {
			...
			listeners: {
				...
				"interactions:action-start": Y,
				"interactions:action-move": Y,
				"interactions:action-end": Y,
		...
		var Et = o((function e(t, n, r, a, o) {
			...
			function e(t) {
				...
				i(this, e), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = {
					...
					event: null,
					eventTarget: null
				}, this.prevEvent = null, this.pointerIsDown = !1, this.pointerWasMoved = !1, this._interacting = !1, this._ending = !1, this._stopped = !0, this._proxy = void 0, this.simulation = null, this.doMove = K((function(e) {
					this.move(e);
				...
				}, this._id = kt++, this._scopeFire = a, this.pointerType = r;
				var o = this;
				this._proxy = {};
				var s = function(e) {
			...
			return o(e, [
				...
				},
				{
					key: "start",
					value: function(e, t, n) {
						return !(this.interacting() || !this.pointerIsDown || this.pointers.length < (e.name === "gesture" ? 2 : 1) || !t.options[e.name].enabled) && (et(this.prepared, e), this.interactable = t, this.element = n, this.rect = t.getRect(n), this.edges = this.prepared.edges ? M({}, this.prepared.edges) : {
							left: !0,
							right: !0,
							top: !0,
							bottom: !0
				...
				},
				{
					...
					value: function(e, t, n) {
						...
						this.pointerIsDown && !this.pointerWasMoved && (r = this.coords.cur.client.x - this.coords.start.client.x, i = this.coords.cur.client.y - this.coords.start.client.y, this.pointerWasMoved = I(r, i) > this.pointerMoveTolerance);
				...
				},
				{
					key: "move",
					value: function(e) {
						e && e.event || be(this.coords.delta), (e = M({
				...
				},
				{
					...
					value: function(e) {
						var t = L(e);
						return this.pointerType === "mouse" || this.pointerType === "pen" ? this.pointers.length - 1 : R(this.pointers, (function(e) {
							return e.id === t;
						}));
					}
				},
				...
				},
				{
					key: "updatePointer",
					value: function(e, t, n, r) {
						var i, a, o, s = L(e), c = this.getPointerIndex(e), l = this.pointers[c];
						return r = !1 !== r && (r || /(down|start)$/i.test(t.type)), l ? l.pointer = e : (l = new Et(s, e, t, null, null), c = this.pointers.length, this.pointers.push(l)), we(this.coords.cur, this.pointers.map((function(e) {
							return e.pointer;
				...
				},
				{
					...
					value: function(e, t, n, r) {
						return new Tt(this, e, this.prepared.name, t, this.element, n, r);
					}
				},
				{
					key: "_fireEvent",
				...
				},
				{
					...
					value: function(e) {
						...
						if (a && n === "move" && (he(this.edges, a, this.coords.delta[this.interactable.options.deltaSource]), a.width = a.right - a.left, a.height = a.bottom - a.top), !1 === this._scopeFire(`interactions:before-action-${n}`, e)) return !1;
		...
		function Mt(e) {
			...
			return Pt(e.coords.cur, t), Pt(e.coords.delta, t), he(e.edges, e.rect, t), t.x = 0, t.y = 0, !0;
		}
		function Nt(e) {
			var t = e.x, n = e.y;
		...
		var Ft = {
			...
			install: function(e) {
				e.Interaction.prototype.offsetBy = Nt;
			},
			listeners: {
				"interactions:new": function(e) {
				...
				"interactions:before-action-start": jt,
				"interactions:before-action-move": jt,
				"interactions:before-action-end": function(e) {
					var t = e.interaction;
					if (Mt(t)) return t.move({ offset: !0 }), t.end(), !1;
				},
				"interactions:stop": function(e) {
					var t = e.interaction;
			...
			return o(e, [
				{
					key: "start",
					value: function(e) {
						var t = this.interaction, n = Lt(t);
						if (!n || !n.enabled) return !1;
						var r = t.coords.velocity.client, i = I(r.x, r.y), a = this.modification ||= new xt(t);
				...
				},
				{
					key: "startInertia",
					value: function() {
						var e = this, t = this.interaction.coords.velocity.client, n = Lt(this.interaction), r = n.resistance, i = -Math.log(n.endSpeed / this.v0) / r;
						this.targetOffset = {
							x: (t.x - i) / r,
							y: (t.y - i) / r
				...
				},
				{
					key: "inertiaTick",
					value: function() {
						var e, t, n, r, i, a, o, s = this, c = this.interaction, l = Lt(c).resistance, u = (c._now() - this.t0) / 1e3;
						if (u < this.te) {
				...
				},
				{
					key: "smoothEndTick",
					value: function() {
						var e = this, t = this.interaction, n = t._now() - this.t0, r = Lt(t).smoothEndDuration;
						if (n < r) {
							var i = {
								x: Bt(n, 0, this.targetOffset.x, r),
								y: Bt(n, 0, this.targetOffset.y, r)
							}, a = {
		...
		var Rt = {
			...
			install: function(e) {
				var t = e.defaults;
				e.usePlugin(Ft), e.usePlugin(Ct), e.actions.phases.inertiastart = !0, e.actions.phases.resume = !0, t.perAction.inertia = {
					enabled: !1,
					resistance: 10,
					minSpeed: 100,
					endSpeed: 10,
			...
			listeners: {
				...
				"interactions:action-resume": Y,
				"interactions:action-inertiastart": Y,
		...
		var Ut = function() {
			function e(t) {
				i(this, e), this.options = void 0, this.types = {}, this.propagationStopped = !1, this.immediatePropagationStopped = !1, this.global = void 0, this.options = M({}, t || {});
			}
			return o(e, [
				{
					key: "fire",
					value: function(e) {
						var t, n = this.global;
						(t = this.types[e.type]) && Ht(e, t), !e.propagationStopped && n && (t = n[e.type]) && Ht(e, t);
					}
				},
				{
					key: "on",
			...
			install: function(e) {
				...
				function o(e, t, r, i) {
					if (e.addEventListener) {
						var o = Gt(i), s = z(n, (function(t) {
							return t.eventTarget === e;
						}));
						s || (s = {
							eventTarget: e,
							events: {}
						}, n.push(s)), s.events[t] || (s.events[t] = []), z(s.events[t], (function(e) {
				...
				function c(e, t) {
					for (var n = Gt(t), i = new Wt(e), a = r[e.type], o = je(e)[0], s = o; S.element(s);) {
						for (var c = 0; c < a.length; c++) {
							var l = a[c], u = l.selector, d = l.context;
							if (j(s, u) && k(d, o) && k(d, s)) {
								var f = l.listeners;
								i.currentTarget = s;
		...
		function Qt(e, t) {
			return function(n) {
				...
				if (/^touch/.test(n.type)) {
					...
					var m = !1;
					if (!O.supportsPointerEvent && /mouse/.test(n.type)) {
		...
		var tn = {
			...
			function e(t, n, r, a) {
				i(this, e), this.target = void 0, this.options = void 0, this._actions = void 0, this.events = new Ut(), this._context = void 0, this._win = void 0, this._doc = void 0, this._scopeEvents = void 0, this._actions = n.actions, this.target = t, this._context = n.context || r, this._win = y(de(t) ? this._context : t), this._doc = this._win.document, this._scopeEvents = a, this.set(n);
			}
			return o(e, [
				{
					key: "_defaults",
				...
				},
				{
					...
					value: function(e, t, n) {
						var r = this, i = this._actions.map[e]?.filterEventType, a = function(e) {
							return (i == null || i(e)) && bt(e, r._actions);
						};
						(S.array(t) || S.object(t)) && this._onOff(X.Off, e, t, void 0, a), (S.array(n) || S.object(n)) && this._onOff(X.On, e, n, void 0, a);
					}
				},
				{
					key: "setPerAction",
					value: function(e, t) {
						...
						for (var r in t) {
							...
							i === "listeners" && this.updatePerActionListeners(e, a.listeners, o), S.array(o) ? a[i] = Pe(o) : S.plainObject(o) ? (a[i] = M(a[i] || {}, q(o)), S.object(n.perAction[i]) && "enabled" in n.perAction[i] && (a[i].enabled = !1 !== o.enabled)) : S.bool(o) && S.object(n.perAction[i]) ? a[i].enabled = o : a[i] = o;
						}
					}
				},
				{
					key: "getRect",
					value: function(e) {
						return e ||= S.element(this.target) ? this.target : null, S.string(this.target) && (e ||= this._context.querySelector(this.target)), le(e);
					}
				},
				{
					key: "rectChecker",
				...
				},
				{
					key: "testAllow",
					value: function(e, t, n) {
						return !e || !!S.element(n) && (S.string(e) ? oe(n, e, t) : !!S.element(e) && k(e, n));
					}
				},
				{
					key: "testIgnore",
				...
				},
				{
					...
					value: function(e, t, n, r, i) {
						...
						var a = F(t, n, i);
						for (var o in a) {
							o === "wheel" && (o = O.wheelEvent);
							for (var s = 0, c = a[o]; s < c.length; s++) {
								var l = c[s];
								bt(o, this._actions) ? this.events[e === X.On ? "on" : "off"](o, l) : S.string(this.target) ? this._scopeEvents[e === X.On ? "addDelegate" : "removeDelegate"](this.target, this._context, o, l, r) : this._scopeEvents[e === X.On ? "add" : "remove"](this.target, o, l, r);
							}
						}
						return this;
					}
				},
				{
					key: "on",
					value: function(e, t, n) {
						return this._onOff(X.On, e, t, n);
					}
				},
				{
					key: "off",
					value: function(e, t, n) {
						return this._onOff(X.Off, e, t, n);
					}
				},
				{
					key: "set",
					value: function(e) {
						...
						for (var n in S.object(e) || (e = {}), this.options = q(t.base), this._actions.methodDict) {
							var r = n, i = this._actions.methodDict[r];
							this.options[r] = {}, this.setPerAction(r, M(M({}, t.perAction), t.actions[r])), this[i](e[r]);
						}
			...
			function e(t) {
				...
				i(this, e), this.list = [], this.selectorMap = {}, this.scope = void 0, this.scope = t, t.addListeners({ "interactable:unset": function(e) {
					var t = e.interactable, r = t.target, i = S.string(r) ? n.selectorMap[r] : r[n.scope.id], a = R(i, (function(e) {
						return e === t;
					}));
					i.splice(a, 1);
				} });
			...
			return o(e, [
				{
					key: "new",
					value: function(e, t) {
						t = M(t || {}, { actions: this.scope.actions });
				...
				},
				{
					...
					value: function(e, t) {
						for (var n = 0, r = this.list; n < r.length; n++) {
							var i = r[n], a = void 0;
							if ((S.string(i.target) ? S.element(e) && j(e, i.target) : e === i.target) && i.inContext(e) && (a = t(i)), a !== void 0) return a;
						}
					}
				}
			]), e;
			...
			function e() {
				var t = this;
				i(this, e), this.id = `__interact_scope_${Math.floor(100 * Math.random())}`, this.isInitialized = !1, this.listenerMaps = [], this.browser = O, this.defaults = q(wt), this.Eventable = Ut, this.actions = {
					map: {},
					phases: {
						start: !0,
						move: !0,
					...
					return t.getPointerAverage = Ee, t.getTouchBBox = De, t.getTouchDistance = Oe, t.getTouchAngle = ke, t.getElementRect = le, t.getElementClientRect = ce, t.matchesSelector = j, t.closest = re, t.globalEvents = {}, t.version = "1.10.27", t.scope = e, t.use = function(e, t) {
						return this.scope.usePlugin(e, t), this;
					}, t.isSet = function(e, t) {
						return !!this.scope.interactables.get(e, t && t.context);
					}, t.on = K((function(e, t, n) {
						...
						return bt(e, this.scope.actions) ? this.globalEvents[e] ? this.globalEvents[e].push(t) : this.globalEvents[e] = [t] : this.scope.events.add(this.scope.document, e, t, { options: n }), this;
					}), "The interact.on() method is being deprecated"), t.off = K((function(e, t, n) {
						if (S.string(e) && e.search(" ") !== -1 && (e = e.trim().split(/ +/)), S.array(e)) {
							for (var r = 0, i = e; r < i.length; r++) {
								var a = i[r];
								this.off(a, t, n);
						...
						var s;
						return bt(e, this.scope.actions) ? e in this.globalEvents && (s = this.globalEvents[e].indexOf(t)) !== -1 && this.globalEvents[e].splice(s, 1) : this.scope.events.remove(this.scope.document, e, t, n), this;
					}), "The interact.off() method is being deprecated"), t.debug = function() {
						return this.scope;
					}, t.supportsTouch = function() {
						return O.supportsTouch;
					}, t.supportsPointerEvent = function() {
						return O.supportsPointerEvent;
					}, t.stop = function() {
				...
				}(this), this.InteractEvent = Tt, this.Interactable = void 0, this.interactables = new rn(this), this._win = void 0, this.document = void 0, this.window = void 0, this.documents = [], this._plugins = {
					list: [],
					map: {}
				...
				},
				{
					...
					value: function(e) {
						return this.isInitialized ? this : function(e, t) {
							return e.isInitialized = !0, S.window(t) && v(t), E.init(t), O.init(t), W.init(t), e.window = t, e.document = t.document, e.usePlugin(tn), e.usePlugin(qt), e;
						}(this, e);
					}
				},
				{
					...
					value: function(e, t) {
						...
						if (e.id && (this._plugins.map[e.id] = e), this._plugins.list.push(e), e.install && e.install(this, t), e.listeners && e.before) {
							for (var n = 0, r = this.listenerMaps.length, i = e.before.reduce((function(e, t) {
								return e[t] = !0, e[on(t)] = !0, e;
							}), {}); n < r; n++) {
								var a = this.listenerMaps[n].id;
								if (a && (i[a] || i[on(a)])) break;
							}
		...
		var sn = new an(), Z = sn.interactStatic, cn = typeof globalThis < "u" ? globalThis : window;
		sn.init(cn);
		var ln = Object.freeze({
			...
			install: function(e) {
				...
				t.snappers = M(t.snappers || {}, ln), t.createSnapGrid = t.snappers.grid;
			}
		}, dn = {
			start: function(e) {
				...
				s === "preserve" && (s = r.width / r.height), t.startCoords = M({}, a), t.startRect = M({}, r), t.ratio = s, t.equalDelta = u;
				var f = t.linkedEdges = {
				...
				if (!1 !== c && M(i, f), d != null && d.length) {
					var m = new xt(e.interaction);
					m.copyFrom(e.interaction.modification), m.prepareStates(d), t.subModification = m, m.startAll(n({}, e));
				}
			},
			set: function(e) {
				var t = e.state, r = e.rect, i = e.coords, a = t.linkedEdges, o = M({}, i), s = t.equalDelta ? fn : pn;
				if (M(e.edges, a), s(t, t.xIsPrimaryAxis, i, r), !t.subModification) return null;
				var c = M({}, r);
				he(a, c, {
					x: i.x - o.x,
					y: i.y - o.y
				...
				return l.changed && (s(t, Math.abs(u.x) > Math.abs(u.y), l.coords, l.rect), M(i, l.coords)), l.eventProps;
			},
			defaults: {
				ratio: "preserve",
				equalDelta: !1,
		...
		var mn = J(dn, "aspectRatio"), hn = function() {};
		hn._defaults = {};
		var gn = hn;
		function Q(e, t, n) {
			return S.func(e) ? N(e, t.interactable, t.element, [
				n.x,
				n.y,
				t
			]) : N(e, t.interactable, t.element);
		}
		var _n = {
			start: function(e) {
				var t = e.rect, n = e.startOffset, r = e.state, i = e.interaction, a = e.pageCoords, o = r.options, s = o.elementRect, c = M({
					left: 0,
					top: 0,
					right: 0,
					bottom: 0
			...
			set: function(e) {
				var t = e.coords, n = e.interaction, r = e.state, i = r.options, a = r.offset, o = Q(i.restriction, n, t);
				if (o) {
					var s = function(e) {
						return !e || "left" in e && "top" in e || ((e = M({}, e)).left = e.x || 0, e.top = e.y || 0, e.right = e.right || e.left + e.width, e.bottom = e.bottom || e.top + e.height), e;
					}(o);
		...
		var Sn = {
			...
			start: function(e) {
				...
				a && (t = pe(Q(a.offset, n, n.coords.start.page))), t ||= {
					x: 0,
					y: 0
				}, i.offset = {
					top: t.y + r.top,
			...
			set: function(e) {
				...
				if (n) {
					var s = M({}, t), c = Q(o.inner, r, s) || {}, l = Q(o.outer, r, s) || {};
			...
			set: function(e) {
				...
				if (i) {
					var o = me(Q(a.min, t, e.coords)) || En, s = me(Q(a.max, t, e.coords)) || Dn;
					n.options = {
						endOnly: a.endOnly,
						inner: M({}, Sn.noInner),
						outer: M({}, Sn.noOuter)
			...
			start: function(e) {
				var t, n = e.interaction, r = e.interactable, i = e.element, a = e.rect, o = e.state, s = e.startOffset, c = o.options, l = c.offsetWithOrigin ? function(e) {
					...
					return pe(N(e.state.options.origin, null, null, [t])) || P(e.interactable, t, e.interaction.prepared.name);
				}(e) : {
					x: 0,
					y: 0
				};
			...
			set: function(e) {
				var t = e.interaction, n = e.coords, r = e.state, i = r.options, a = r.offsets, o = P(t.interactable, t.element, t.prepared.name), s = M({}, n), c = [];
				...
				for (var v = {
					...
					var b = c[y], x = b.range, ee = b.x - s.x, te = b.y - s.y, C = I(ee, te), ne = C <= x;
					x === 1 / 0 && v.inRange && v.range !== 1 / 0 && (ne = !1), v.target && !(ne ? v.inRange && x !== 1 / 0 ? C / x < v.distance / v.range : x === 1 / 0 && v.range !== 1 / 0 || C < v.distance : !v.inRange && C < v.distance) || (v.target = b, v.distance = C, v.range = x, v.inRange = ne, v.delta.x = ee, v.delta.y = te);
				}
			...
			install: function(e) {
				var t = e.interactStatic;
				for (var n in e.usePlugin(Ct), e.usePlugin(un), t.modifiers = Nn, Nn) {
			...
			function n(e, r, a, o, s, c) {
				var l;
				if (i(this, n), ve(d(l = t.call(this, s)), a), a !== r && ve(d(l), r), l.timeStamp = c, l.originalEvent = a, l.type = e, l.pointerId = L(r), l.pointerType = Ae(r), l.target = o, l.currentTarget = null, e === "tap") {
			...
			install: function(e) {
				e.pointerEvents = In, e.defaults.actions.pointerEvents = In.defaults, M(e.actions.phaselessTypes, In.types);
			},
			listeners: {
				"interactions:new": function(e) {
					var t = e.interaction;
				...
				"interactions:move": function(e, t) {
					var n = e.interaction, r = e.pointer, i = e.event, a = e.eventTarget;
					e.duplicate || n.pointerIsDown && !n.pointerWasMoved || (n.pointerIsDown && Rn(e), $({
						interaction: n,
						pointer: r,
						event: i,
						eventTarget: a,
				...
				"interactions:down": function(e, t) {
					(function(e, t) {
						for (var n = e.interaction, r = e.pointer, i = e.event, a = e.eventTarget, o = e.pointerIndex, s = n.pointers[o].hold, c = ue(a), l = {
							interaction: n,
							pointer: r,
							event: i,
							eventTarget: a,
						...
						if (l.targets.length) {
							for (var d = 1 / 0, f = 0, p = l.targets; f < p.length; f++) {
		...
		function $(e, t) {
			var n = e.interaction, r = e.pointer, i = e.event, a = e.eventTarget, o = e.type, s = e.targets, c = s === void 0 ? Ln(e, t) : s, l = new Fn(o, r, i, a, n, t.now());
		...
		var Vn = {
			...
			install: function(e) {
				...
				t.prototype.pointerEvents = function(e) {
					return M(this.events.options, e), this;
				};
			...
			listeners: {
				...
				"interactable:set": function(e, t) {
					...
					M(n.events.options, t.pointerEvents.defaults), M(n.events.options, r.pointerEvents || {});
				}
			}
		};
		if (Z.use(yt), Z.use(Ft), Z.use({
			id: "pointer-events",
			install: function(e) {
				e.usePlugin(zn), e.usePlugin(Vn), e.usePlugin(Hn);
			}
		}), Z.use(Vt), Z.use(Pn), Z.use(gt), Z.use(Ye), Z.use($e), Z.use({
			id: "reflow",
			install: function(e) {
				var t = e.Interactable;
				e.actions.phases.reflow = !0, t.prototype.reflow = function(t) {
					return function(e, t, n) {
						for (var r = e.getAllElements(), i = n.window.Promise, a = i ? [] : null, o = function() {
							...
							if (!c) return 1;
							var l, u = z(n.interactions.list, (function(n) {
							...
							if (u) u.move(), a && (l = u._reflowPromise || new i((function(e) {
								...
								l = function(e, t, n, r, i) {
									...
									a.interactable = t, a.element = n, a.prevEvent = i, a.updatePointer(i, i, n, !0), be(a.coords.delta), et(a.prepared, r), a._doPhase(o);
		...
		}), Z.default = Z, (t === void 0 ? "undefined" : r(t)) === "object" && t) try {
			t.exports = Z;
		} catch {}
